using ComponentProcessing.API.CPMappers;
using ComponentProcessing.API.Data;
using ComponentProcessing.API.Repository;
...
namespace ComponentProcessing.API
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ComponentProcessing.API v1"));
            }
